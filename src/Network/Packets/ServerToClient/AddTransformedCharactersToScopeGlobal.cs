// <copyright file="AddTransformedCharactersToScopeGlobal.cs" company="MUnique">
...
/// </summary>
public readonly ref partial struct AddTransformedCharactersToScopeGlobalRef
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the <see cref="CharacterDataGlobalRef" /> with the specified character index.
    /// </summary>
    /// <value>
    /// The <see cref="CharacterDataGlobalRef" />.
    /// </value>
    ...
    /// </remarks>
    public CharacterDataGlobalRef this[int characterIndex]
    {
        get
        {
            var index = this.GetIndexOfCharacter(characterIndex, out _);
            return new CharacterDataGlobalRef(this._data.Slice(index));
        }
    }
    ...
    private int GetIndexOfCharacter(int characterIndex, out int nextIndex)
    {
        ...
        const int sizeWithoutEffects = 42;
