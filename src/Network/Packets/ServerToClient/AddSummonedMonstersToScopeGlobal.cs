// <copyright file="AddSummonedMonstersToScopeGlobal.cs" company="MUnique">
...
/// </summary>
public readonly ref partial struct AddSummonedMonstersToScopeGlobalRef
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the <see cref="SummonedMonsterDataGlobalRef" /> with the specified character index.
    /// </summary>
    /// <value>
    /// The <see cref="SummonedMonsterDataGlobalRef" />.
    /// </value>
    ...
    /// </remarks>
    public SummonedMonsterDataGlobalRef this[int characterIndex]
    {
        get
        {
            var index = this.GetIndexOfMonster(characterIndex, out _);
            return new SummonedMonsterDataGlobalRef(this._data[index..]);
        }
    }
    ...
    private int GetIndexOfMonster(int characterIndex, out int nextIndex)
    {
        ...
        const int sizeWithoutEffects = 24;
